...
pred_folder = 'DANNCE/predict_results/six_points_multi_test_0calib'
...
pred_path = os.path.join(base_path, pred_folder, 'save_data_AVG0.mat')
N_FRAMES = 100
START_FRAME = 0
ANIMAL= 'mouse20' #'mouse22'
cam = 'Camera6' 
vid_title = 'combined_cam6_100'
