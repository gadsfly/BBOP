...
base_path = 'G:/Videos/6cam/lq53/2024_08_26/' # where calib is saved to, and where your actual recorded mice video locates.  2024_09_16_test_chris_new
# calib_path = os.path.join(base_path, 'calib_befor') #from chris, with 
calib_path = 'G:\Videos\\6cam\\lq53\\2024_08_26\\calib_before\\z_updated_hires'
vid_path = '20240717_PMCr1'

calibname = os.path.basename(calib_path)
output_file = f'z_updated_{calibname}_label3d_dannce.mat'
