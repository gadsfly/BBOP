...
# Base output path
base_out_path = "/home/lq53/mir_repos/dappy_24_nov/byws_version/250115_opti_summm_only_vel_ang_pose/"

# List of perplexities to iterate over
perplexities = [55, 60, 70] #[100, 200, 300, 400, 500] #[70, 80, 90, 40]

# Path to your main script
script_path = "/home/lq53/mir_repos/BBOP/random tests/dappy_backups/iter_com_features/manual_com_vel_ang_pose.py" #"/home/lq53/mir_repos/BBOP/random tests/dappy_backups/iter_com_features/mannaul_com_all.py" #"/home/lq53/mir_repos/dappy_24_nov/byws_version/mir_runopti.py"  # Replace with the actual script path
