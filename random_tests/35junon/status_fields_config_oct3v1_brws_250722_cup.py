...
STATUS_FIELDS_CONFIG = {
        ...
        'conditions': [
            ...
            },
            {
                ...
                'value': 1  # Set to 1 if "social" is in the path
                        ...
                        {
                'condition': lambda **kwargs: 'conspecific' in kwargs['subfolder_path'].lower(),
                'value': 1  # Set to 1 if "social" is in the path
            },
                        {
    ...
    #     'conditions': [
    #         {
    #             'pink': lambda **kwargs: 'pink' in kwargs['subfolder_path'].lower(),
    #             'value': 1  # Set to 1 if "social" is in the path
    #         }]
    ...
    #     'conditions': [
    #         {
    #             'pink': lambda **kwargs: 'clear' in kwargs['subfolder_path'].lower(),
    #             'value': 1  # Set to 1 if "social" is in the path
    #         }]
    ...
    #     'conditions': [
    #         {
    #             'pink': lambda **kwargs: 'blue' in kwargs['subfolder_path'].lower(),
    #             'value': 1  # Set to 1 if "social" is in the path
    #         }]
    ...
    #     'conditions': [
    #         {
    #             'pink': lambda **kwargs: 'orange' in kwargs['subfolder_path'].lower(),
    #             'value': 1  # Set to 1 if "social" is in the path
    #         }]
